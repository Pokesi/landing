...
if (!isBrowser) {
  ...
  function (_React$Component) {
    ...
    _proto.render = function render() {
      return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(EmotionCacheContext.Provider, this.state, this.props.children(this.state.value));
    };
  ...
  withEmotionCache = function withEmotionCache(func) {
    return function (props) {
      return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(EmotionCacheContext.Consumer, null, function (context) {
        if (context === null) {
          return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(BasicProvider, null, function (newContext) {
...
var render = function render(cache, props, theme, ref) {
  ...
  if (!isBrowser && rules !== undefined) {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)("style", (_ref = {}, _ref["data-emotion-" + cache.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
  ...
  _proto.render = function render() {
    if (!isBrowser) {
      ...
      if (!shouldCache) {
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)("style", (_ref = {}, _ref["data-emotion-" + this.props.cache.key] = serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(ThemeContext.Consumer, null, function (theme) {
    ...
    var css = function css() {
      ...
      if (isBrowser) {
        ...
        var res = (0,_emotion_utils__WEBPACK_IMPORTED_MODULE_3__.insertStyles)(context, serialized, false);
    ...
    if (!isBrowser && rules.length !== 0) {
      ...
      return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)("style", (_ref = {}, _ref["data-emotion-" + context.key] = serializedHashes.substring(1), _ref.dangerouslySetInnerHTML = {
        __html: rules
...
var plugins = [{
  ...
  options: {
    "plugins": [],
    "languages": ["en", "cn", "ja", "de", "es", "fr", "ko", "it", "nl", "pl", "vi", "ru", "pt"],
    "defaultLanguage": "en",
    "path": "C:\\Data\\rave\\landing-v2/locales",
    "siteUrl": "app.ens.domains",
    "i18nextOptions": {
      "debug": true,
      "lng": "en",
      "fallbackLng": "en",
      "whitelist": ["en", "cn", "ja", "de", "es", "fr", "ko", "it", "nl", "pl", "vi", "ru", "pt"],
      "interpolation": {
        "escapeValue": false
      }
    },
  ...
  options: {
    "plugins": [],
    "fonts": ["Overpass+Mono:300,400\"", "Overpass:100,200,300,400,500,700,800,900", "Karma: 400,300,200,100"]
  }
}, {
...
var _i18nextContext = __webpack_require__(/*! ../i18nextContext */ "./node_modules/gatsby-plugin-react-i18next/dist/i18nextContext.js"); // @ts-ignore
  ...
  if (isRedirect) {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (detected !== defaultLanguage) {
        ...
        var newUrl = (0, _gatsby.withPrefix)("/" + detected + location.pathname + queryParams);
...
function renderNodes(children, targetString, i18n, i18nOptions, combinedTOpts) {
  ...
  function pushTranslatedJSX(child, inner, mem, i) {
    ...
    mem.push(react__WEBPACK_IMPORTED_MODULE_3___default().cloneElement(child, _objectSpread({}, child.props, {
      key: i
    }), inner));
  }
...
function Trans(_ref) {
  ...
  if (!i18n) {
    (0,_utils__WEBPACK_IMPORTED_MODULE_5__.warnOnce)('You will need pass in an i18next instance by using i18nextReactModule');
    return children;
  }
  ...
  var reactI18nextOptions = _objectSpread({}, (0,_context__WEBPACK_IMPORTED_MODULE_6__.getDefaults)(), {}, i18n.options && i18n.options.react);
...
function useTranslation(ns) {
  ...
  if (!i18n) {
    (0,_utils__WEBPACK_IMPORTED_MODULE_4__.warnOnce)('You will need pass in an i18next instance by using initReactI18next');
  ...
  var i18nOptions = _objectSpread({}, (0,_context__WEBPACK_IMPORTED_MODULE_3__.getDefaults)(), {}, i18n.options.react, {}, props);
...
/***/ "react-dom/server":
/*!*********************************************************************************!*\
  !*** external "C:\\Data\\rave\\landing-v2\\node_modules\\react-dom\\server.js" ***!
  \*********************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("C:\\Data\\rave\\landing-v2\\node_modules\\react-dom\\server.js");
